...
import es.caib.scsp.api.cedent.client.SCDHPAJUv3.services.auth.Authentication;
import es.caib.scsp.api.cedent.client.SCDHPAJUv3.services.auth.HttpBasicAuth;
import es.caib.scsp.api.cedent.client.SCDHPAJUv3.services.auth.ApiKeyAuth;
import es.caib.scsp.api.cedent.client.SCDHPAJUv3.services.auth.OAuth;

@Component("es.caib.scsp.api.cedent.client.SCDHPAJUv3.services.ApiClient")
public class ApiClient {
    ...
    private String basePath = "https://{username}.{domain}:{port}/{basePath}";
