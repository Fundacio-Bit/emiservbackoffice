...
@Component("es.caib.scsp.api.cedent.client.SCDHPAJUv3.api.ScdhpajUv3Api")
public class ScdhpajUv3Api {
    ...
    public Resultado peticionSincrona(Solicitud body) throws RestClientException {
        ...
        String path = UriComponentsBuilder.fromPath("/SCDHPAJUv3/peticionSincrona").build().toUriString();
