...
import es.caib.scsp.api.cedent.client.SCDCPAJUv3.api.Scdcpajuv3ApiCustom;
...
public class SCDCPAJUv3Client extends CedentClient {
    ...
    private es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum normalizeTipoDocumentacionCedent(
            es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion tipo) {
        ...
        if (tipo == es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion.Pasaporte) {
            return es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum.PASSAPORT;
        }

        if (tipo == es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion.NIF) {
            return es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum.NIF;
        }

        if (tipo == es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion.NIE) {
            return es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum.NIE;
        }

        if (tipo == es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion.DNI) {
            return es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum.DNI;
        }
    ...
    private es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion normalizeTipoDocumentacionBackoffice(
            es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum tipo) {

        if (tipo == null) {
            return null;
        }

        if (tipo == es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum.PASSAPORT) {
            return es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion.Pasaporte;
        }

        if (tipo == es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum.NIF) {
            return es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion.NIF;
        }

        if (tipo == es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum.NIE) {
            return es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion.NIE;
        }

        if (tipo == es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Documentacion.TipoEnum.DNI) {
    ...
    private void setDatosPeticion() throws JAXBException, IOException {
        ...
        try {
            XmlManager<SCDCPAJUv3PeticionDatosEspecificos> manager = new XmlManager<SCDCPAJUv3PeticionDatosEspecificos>(
                    SCDCPAJUv3PeticionDatosEspecificos.class);
    ...
    private void setDatosRespuesta() throws JAXBException, ParserConfigurationException {
        ...
        XmlManager<SCDCPAJUv3RespuestaDatosEspecificos> manager = new XmlManager<SCDCPAJUv3RespuestaDatosEspecificos>(
                SCDCPAJUv3RespuestaDatosEspecificos.class);

        XmlSchema xmlSchemaAnnotation = manager.getXmlSchemaAnnotation();

        log.info("SCDCPAJUv3Client :: Datos Especificos NAMESPACE: "
                + ((xmlSchemaAnnotation != null) ? xmlSchemaAnnotation.namespace() : "No xmlSchemaAnnotation"));
        log.info("SCDCPAJUv3Client :: Datos Especificos LOCATION: "
        ...
        log.info("SCDCPAJUv3Client :: Datos Especificos XmlRoot NAMESPACE: "
                + ((xmlRootElementAnnotation != null) ? xmlRootElementAnnotation.namespace()
                        : "No xmlRootElementAnnotation"));
        log.info("SCDCPAJUv3Client :: Datos Especificos XmlRoot LOCATION: "
    ...
    private es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Resultado getResultado(
            es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Solicitud solicitud) throws ApiException {
        ...
        try {
            ...
            if (responseBody != null && !responseBody.trim().isEmpty()) {
                try {
                    ...
                    log.debug("SCDCPAJUv3Client :: getResultado :: resposta error no JSON", ioex);
                }
            }
         ...
         * Logger.getLogger(SCDCPAJUv3Client.class.getName()).log(Level.SEVERE, null,
         * ex);
         * } catch (UnknownHttpStatusCodeException ex) {
         * Logger.getLogger(SCDCPAJUv3Client.class.getName()).log(Level.WARNING, null,
         * ex);
         * throw new WrongApiStatusException(ex.getStatusText(),
         * ex.getResponseBodyAsString(), "Format de resposta no especificat: " +
    ...
    private es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Solicitud adaptaSolicitud(
        ...
        if (titular != null) {
            ...
            if (documentacion != null) {
                ...
                String tipoDocumentacion = documentacion.getTipo();
                es.caib.emiserv.logic.intf.service.ws.backoffice.TipoDocumentacion tipoDocumentacionBackoffice = normalizeTipoDocumentacionBackoffice(tipoDocumentacion);
                tipo = normalizeTipoDocumentacionCedent(tipoDocumentacionBackoffice);
    ...
    private es.caib.scsp.esquemas.SCDCPAJUv3.respuesta.datosespecificos.Resultado adaptaResultado(
            es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Resultado res) {
            ...
            if (lPrs != null) {
                ...
                for (es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.Persona per : lPrs) {
                    ...
                    if (per != null) {
                        ...
                        es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.PeriodoInscripcion pin = per
                                .getPeriodoInscripcion();
                        if (pin != null) {
                            ...
                            es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.MotivoInscripcion mins = pin
                            ...
                            if (mins != null) {
                                ...
                                es.caib.scsp.api.cedent.client.SCDCPAJUv3.model.MotivoInscripcion.CodigoVariacionEnum codigo = mins
                                        .getCodigoVariacion();
                                if (codigo != null) {
                                ...
                                motivoInscripcion
                                        .setDescripcion((mins.getDescripcion() != null) ? mins.getDescripcion() : "OM");
    ...
    public void peticionSincrona() {
        ...
        if (pde != null) {
            ...
            if (pde.getSolicitud() != null) {
                log.info("SCDCPAJUv3Client :: Paràmetres de consulta: " + "Provincia: "
