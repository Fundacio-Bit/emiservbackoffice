...
import es.caib.scsp.api.cedent.client.SVDSCTFNWS01v3.api.Svdsctfnws01v3ApiCustom;
        ...
        try {
            ...
            if (responseBody != null && !responseBody.trim().isEmpty()) {
                try {
                    ...
                    log.debug("SVDSCTFNWS01v3Client :: getResultado :: resposta error no JSON", ioex);
                }
            }
