 ...
 * generated in the es.caib.emiservbackoffice.ws.api package. 
...
public class ObjectFactory {
    ...
    private final static QName _WsI18NError_QNAME = new QName("http://impl.ws.emiservbackoffice.caib.es/", "WsI18NError");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: es.caib.emiservbackoffice.ws.api
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://impl.ws.emiservbackoffice.caib.es/", name = "WsI18NError")
