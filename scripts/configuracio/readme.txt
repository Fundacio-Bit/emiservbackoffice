...
amb la propietat de sistema "es.caib.emiservbackoffice.properties".
...
a dins l'apartat de <system-properties>:
    ...
    ...
    <system-properties>
        <property name="es.caib.emiservbackoffice.properties" value="/ruta/cap/al/fitxer/emiservbackoffice.properties"/>
    </system-properties>
    ...
