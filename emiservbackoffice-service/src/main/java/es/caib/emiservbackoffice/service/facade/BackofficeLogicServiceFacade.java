package es.caib.emiservbackoffice.service.facade;
 ...
 * @author areus
 */
public interface BackofficeLogicServiceFacade {

    /** Processa una peticio i retorna la resposta
     * @param peticion contingut de la peticio
     * @return la resposta a la petició
     * Pendent de excepció
     */
    Respuesta peticionSincrona(Peticion peticion);
