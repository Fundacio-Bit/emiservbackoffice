package es.caib.emiservbackoffice.api.interna.services;


import es.caib.emiservbackoffice.service.exception.ServiceException;
import es.caib.emiservbackoffice.service.model.EstatPublicacio;
    ...
    public static WebArchive createDeployment() {
        try {
            WebArchive war = ShrinkWrap.create(WebArchive.class, "test.war")
                    ...
                    .addPackages(false, "es.caib.emiservbackoffice.api.interna")
                    .addPackages(false, "es.caib.emiservbackoffice.api.interna.services")
                    .addPackages(true, "es.caib.emiservbackoffice.commons.rest")
                    .addPackages(true, "es.caib.emiservbackoffice.service")
                    .addPackages(true, "es.caib.emiservbackoffice.ejb")
                    .addPackages(true, "es.caib.emiservbackoffice.persistence")
                    .addAsResource(
