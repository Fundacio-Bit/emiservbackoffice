 ...
 */
@Entity
@SequenceGenerator(name = "uo-sequence", sequenceName = "EBO_UNITATORGANICA_SEQ", allocationSize = 1)
@Table(name = "EBO_UNITATORGANICA",
        uniqueConstraints = {
                @UniqueConstraint(name = "EBO_UNITAT_CODIDIR3_UK", columnNames = "CODIDIR3")
        },
        indexes = {
                @Index(name = "EBO_UNITAT_PK_I", columnList = "ID"),
                @Index(name = "EBO_UNITAT_CODIDIR3_UK_I", columnList = "CODIDIR3")
        }
)
@NamedQueries({
